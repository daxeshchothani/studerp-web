...
const HomePage = () => {
  usePageMeta(
    ...
    'Comprehensive student management software for schools, colleges, and universities. Features include attendance tracking, grade management, parent portal, and analytics.',
